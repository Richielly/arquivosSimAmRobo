...
class Arquivo:
    ...
    def criar_diretorio(exercicio):
        ...
        if os.path.exists("C:\\Users\\richielly.carvalho\\Downloads\\SimAm\\"+str(exercicio)):
            return True
        else:
            caminho = os.makedirs("C:\\Users\\richielly.carvalho\\Downloads\\SimAm\\"+str(exercicio))
            return False
    ...
    def deletarZip():
        ...
        for diretorios in origem:
            ...
            os.chdir('C:\\Users\\richielly.carvalho\Downloads\SimAm'+'\\'+diretorios)
